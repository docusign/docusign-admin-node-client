...
(function(factory) {
  ...
  var exports = {
    ...
    /**
     * The OrganizationConnectConfigResponse model constructor.
     * @property {module:model/OrganizationConnectConfigResponse}
     */
    OrganizationConnectConfigResponse: OrganizationConnectConfigResponse,
    /**
     * The OrganizationConnectConfigsResponse model constructor.
     * @property {module:model/OrganizationConnectConfigsResponse}
     */
    OrganizationConnectConfigsResponse: OrganizationConnectConfigsResponse,
    /**
     * The OrganizationConnectConfigurationDetailsResponse model constructor.
     * @property {module:model/OrganizationConnectConfigurationDetailsResponse}
     */
    OrganizationConnectConfigurationDetailsResponse: OrganizationConnectConfigurationDetailsResponse,
    /**
     * The OrganizationConnectConfigurationRequest model constructor.
     * @property {module:model/OrganizationConnectConfigurationRequest}
     */
    OrganizationConnectConfigurationRequest: OrganizationConnectConfigurationRequest,
    /**
     * The OrganizationConnectHmacSecretsResponse model constructor.
     * @property {module:model/OrganizationConnectHmacSecretsResponse}
     */
    OrganizationConnectHmacSecretsResponse: OrganizationConnectHmacSecretsResponse,
    /**
     * The OrganizationConnectOAuthConfiguration model constructor.
     * @property {module:model/OrganizationConnectOAuthConfiguration}
     */
    OrganizationConnectOAuthConfiguration: OrganizationConnectOAuthConfiguration,
    /**
    ...
    /**
     * The OrgConnectApi service constructor.
     * @property {module:api/OrgConnectApi}
     */
    OrgConnectApi: OrgConnectApi,
    /**
