...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DocusignAdmin.OrganizationConnectConfigurationDetailsResponse = factory(root.DocusignAdmin.ApiClient, root.DocusignAdmin.ConnectEventData);
  }
  ...
  /**
   * The OrganizationConnectConfigurationDetailsResponse model module.
   * @module model/OrganizationConnectConfigurationDetailsResponse
   */

  /**
   * Constructs a new <code>OrganizationConnectConfigurationDetailsResponse</code>.
   * @alias module:model/OrganizationConnectConfigurationDetailsResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>OrganizationConnectConfigurationDetailsResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OrganizationConnectConfigurationDetailsResponse} obj Optional instance to populate.
   * @return {module:model/OrganizationConnectConfigurationDetailsResponse} The populated <code>OrganizationConnectConfigurationDetailsResponse</code> instance.
   */
